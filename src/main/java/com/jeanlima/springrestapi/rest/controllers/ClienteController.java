...
//    @GetMapping("{id}")
//    public String getClienteAndHisPedidos (@PathVariable Integer id) {
//        String response = clientes
//                                    .findById(id)
//                                    .map( clienteExistente -> {
//                                        clienteExistente.getPedidos().
//                                        return clienteExistente;
//                                    }).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Cliente não encontrado")).toString();
//
//        return response;
//
//    }
